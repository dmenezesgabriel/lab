...
Imagine deleting the proposed module entirely. If its complexity vanishes — callers handle it trivially — it is a pass-through. Do not add it. If its complexity reappears across multiple callers, the module is earning its keep and is justified.
